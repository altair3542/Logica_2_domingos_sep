...
#cuando los ejercicios o el problema que tenemos que solucionar requiere que hagamos multiples iteraciones sobre un valor que ya se esta iterando, tenemos que anidar.
